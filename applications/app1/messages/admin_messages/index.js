...
module.exports.duplicate_admin_message = "🔁 این مدیر قبلا ثبت شده است";
module.exports.no_admin_added_message = "🤷🏻‍♂️ مدیری افزوده نشده است";
module.exports.no_admin_found_message = "🤷🏻‍♂️ مدیری یافت نشد";
module.exports.invalid_username_entered_message = "فرم یوزرنیم وارد شده نامعتبر است ❗️ ";
module.exports.enter_plan_price_message = "🔹 لطفا قیمت طرح را وارد نمایید (به تومان) : ";
...
module.exports.no_user_found = "🤷🏻‍♂️ کاربری یافت نشد.";
...
module.exports.no_one_has_registered_recently = "🤷🏻‍♂️ اخیرا کسی ثبت نام نکرده است.";
...
module.exports.no_plan_registered_message = "🤷🏻‍♂️ هیچ طرحی ثبت نشده است.";
module.exports.no_plan_found_message = "🤷🏻‍♂️ هیچ طرحی برای ثبت نام یافت نشد.";
module.exports.do_you_want_to_remove_this_plan_message = "❓ آیا تمایل به حذف این طرح دارید؟";
module.exports.content_updated_successfully_message = "✅ محتوا با موفقیت بروزرسانی شد."
//************************************* admin section *****************************************\\
...
module.exports.enter_adviser_username_or_char_id_for_remove_message =
  "🔹 لطفا یوزر نیم  یا چت آی دی مشاوری که قصد حذف آنرا دارید به فرم 'nemoone@' وارد نمایید : ";
...
module.exports.no_adviser_found_with_this_input =
  "🤷🏻‍♂️ مشاوری با این اطلاعات وارد شده یافت نشد.";
module.exports.adviser_not_found = "🤷🏻‍♂️ مشاور مورد نظر یافت نشد.";
...
module.exports.promote_adviser_message = `🔹 لطفا یوزرنیم یا چت آی دی مشاوری که قصد ارتقای درجه ی آن را دارید به فرم 'nemoone@' وارد نمایید : 
🔸 توجه : در صورت اشتباه وارد نمودن ، مشاور ارتقای رتبه نخواهد یافت.`;
...
module.exports.demote_adviser_message = `🔹 لطفا یوزرنیم یا چت آی دی مشاوری که قصد تنزل درجه ی آن را دارید به فرم 'nemoone@' وارد نمایید : 
🔸 توجه : در صورت اشتباه وارد نمودن ، مشاور تنزل رتبه نخواهد یافت.`;
...
🔻 نام کاربری : @${data.student_username ? data.student_username : username ? username : "فاقد نام کاربری"}
...
module.exports.there_is_no_registered_title_message = "🤷🏻‍♂️ عنوانی برای تولید محتوا ثبت نشده است."
module.exports.no_title_registered_recently_message = "🤷🏻‍♂️ اخیرا عنوانی برای تولید محتوا افزوده نشده است."
